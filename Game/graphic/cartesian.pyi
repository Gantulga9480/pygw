...
class CartesianPlane:
    ...
    def __init__(self, window_size: tuple, unit_length: float, parent_vector: Vector2d = None, set_limit: bool = True, logging: bool = True) -> None: ...
    @property
    def X(self) -> float: ...
    @X.setter
    ...
    def createVector(self, x: float = 1, y: float = 0, max_length: float = 0, min_length: float = 1, set_limit: bool = False) -> Vector2d: ...
    def createRandomVector(self, max_length: float = 0, min_length: float = 1, set_limit: bool = False) -> Vector2d: ...
    def show(self, window: Surface, color: Color, width: int) -> None: ...
...
class Vector2d(vector2d):
    ...
    def __init__(self, space: CartesianPlane, x: float = 1, y: float = 0, max_length: float = 0, min_length: float = 1, set_limit: bool = False) -> None: ...
    @property
    def X(self) -> float: ...
    @property
    def Y(self) -> float: ...
    ...
    def show(self, window: Surface, color: Color, width: float) -> None: ...
