...
class CartesianPlane:
    ...
    def to_x(self, X: float) -> float: ...
    def to_y(self, Y: float) -> float: ...
    def createVector(self, x: float = 1, y: float = 0, max_length: float = 0, min_length: float = 1) -> Vector2d: ...
    def createRandomVector(self, max_length: float = 0, min_length: float = 1) -> Vector2d: ...
